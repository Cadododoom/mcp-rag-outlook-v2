...
def run_conversation(
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        #
        # Context-Cliff Guardrail: Force system prompt rebuild to inject warning header when nearing limits
        ...
        if comp:
            ...
            if context_max > 0 and measured_used > 0 and (measured_used / context_max) >= 0.90:
                ...
                active_system_prompt = agent._build_system_prompt(system_message)
            ...
            try:
                ...
                if is_context_length_error:
                    ...
                    if available_out is not None:
                        ...
                        safe_out = max(1, available_out - 2048)  # large safety margin
